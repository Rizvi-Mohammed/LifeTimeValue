...
let PersonalizationController = class PersonalizationController {
    ...
    async generateEmail(userProfile) {
...
], PersonalizationController.prototype, "generateEmail", null);
exports.PersonalizationController = PersonalizationController = __decorate([
    (0, common_1.Controller)('api/personalize'),
    __metadata("design:paramtypes", [personalization_service_1.PersonalizationService])
